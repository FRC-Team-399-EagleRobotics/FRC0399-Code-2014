...
public class TwoBallAuton extends CommandGroup {
    ...
    public TwoBallAuton() {
        ...
        // #yolo
        this.addSequential(new IntakeCommand(-.25, Constants.Intake.EXTENDED, 1.0));
        this.addSequential(new WaitCommand(.5));
        this.addSequential(new IntakeCommand(-.25, Constants.Intake.EXTENDED, 2.0));
        this.addSequential(new DriveDistanceCommand(-72, .8, 10));
        this.addSequential(new IntakeCommand(-1, Constants.Intake.EXTENDED, 2.0));
