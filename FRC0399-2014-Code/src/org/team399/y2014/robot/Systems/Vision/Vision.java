...
/**
 * Class containing image processing algorithms used in hot goal recognition
 * during the autonomous portion of the Aerial Assist game.
 *
            ...
            if (filteredImage.getNumberParticles() > 0) {
                for (int i = 0; i < MAX_PARTICLES && i < filteredImage.getNumberParticles(); i++) {
                    ...
                    if (scoreCompare(scores[i], false)) {
                        ...
                        hotGoalPresent = true;
                        System.out.println("Hot goal detected at x: " + report.center_mass_x + "y: " + report.center_mass_y);
                ...
                for (int i = 0; i < verticalTargetCount; i++) {
                    ...
                    hotGoalPresent = target.Hot = hotOrNot(target);
                }
...
//                ex.printStackTrace();
    ...
    boolean hotGoalPresent = false;

    public boolean getHotGoal() {
        return hotGoalPresent;
    }
